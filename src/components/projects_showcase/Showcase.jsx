    ...
    return (
        <div className={showcasestyle.showcase}>
            ...
            <div className={showcasestyle.projects}>
                ...
                <Project className={showcasestyle.project} projectName="Recipe Management" projectDescription="Application that allows save, upload and manage their recipes" projectLink="https://github.com/jtp0330/recipeManagement" />
            </div>
        </div>
