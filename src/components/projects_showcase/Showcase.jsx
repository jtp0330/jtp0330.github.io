    ...
    return (
        <div className={`${showcasestyle.showcase} p-5`}>
            ...
            <div className={showcasestyle.projects}>
                ...
                <Project className={showcasestyle.project} projectName="Bread" projectDescription="Mobile application, allowing users to create, and manage their budget goals" projectLink="https://github.com/jtp0330/Bread-app" projectImage="./src/assets/images/breadicon.PNG" />
                ...
                <Project className={showcasestyle.project} projectName="Overcast" projectDescription="2D Platformer, where you play as a winged pig, soaring through the clouds, spreading rainbows and sunshine" projectLink="https://github.com/jtp0330/Overcast" projectImage="./src/assets/images/overcast.PNG" />
            </div>
        </div>
